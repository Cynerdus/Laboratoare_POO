...
public class Main {
    public static void main(String[] args) {
        ...
        copyStudents.sort(((o2, o1) -> (o1.getAverageGrade() == o2.getAverageGrade()) ? (o1.getSurname().compareTo(o2.getSurname()) == 0) ?
                o1.getName().compareTo(o2.getName()) : o1.getSurname().compareTo(o2.getSurname()) :
                (o1.getAverageGrade() > o2.getAverageGrade()) ? 1 : -1));
